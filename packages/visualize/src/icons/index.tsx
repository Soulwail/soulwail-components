...
import { ReactComponent as PercentStackAreaChartNavySvg } from './percent-stack-area-chart-navy.svg';
import { ReactComponent as PercentStackAreaChartSvg } from './percent-stack-area-chart.svg';
import {
    ReactComponent as PercentStackBarChartNavySvg,
    ReactComponent as PercentStackBarChartSvg,
...
import { ReactComponent as StackAreaChartNavySvg } from './stack-area-chart-navy.svg';
import { ReactComponent as StackAreaChartSvg } from './stack-area-chart.svg';
import { ReactComponent as StackBarChartNavySvg } from './stack-bar-chart-navy.svg';
import { ReactComponent as StackBarChartSvg } from './stack-bar-chart.svg';
import { ReactComponent as StackHorizontalBarChartNavySvg } from './stack-horizontal-bar-chart-navy.svg';
import { ReactComponent as StackHorizontalBarChartSvg } from './stack-horizontal-bar-chart.svg';
import { ReactComponent as StatisticCardNavySvg } from './statistic-card-navy.svg';
...
const AreaChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <AreaChartNavySvg />} {...props} />
);
...
const BasicLineChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <BasicLineChartNavgSvg />} {...props} />
);
...
const PercentStackAreaChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <PercentStackAreaChartNavySvg />} {...props} />
);
...
const PercentStackBarChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <PercentStackBarChartNavySvg />} {...props} />
);
...
const PercentStackHorizontalBarChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <PercentStackHorizontalBarChartNavySvg />} {...props} />
);
...
const PieChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <PieChartNavySvg />} {...props} />
);
...
const StackAreaChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <StackAreaChartNavySvg />} {...props} />
);
...
const StackBarChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <StackBarChartNavySvg />} {...props} />
);
...
const StackHorizontalBarChartNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <StackHorizontalBarChartNavySvg />} {...props} />
);
...
const StatisticCardNavyIcon = (props: Partial<CustomIconComponentProps>) => (
    <Icon component={() => <StatisticCardNavySvg />} {...props} />
);
...
const TableViewNavyIcon = (props: Partial<CustomIconComponentProps>) => (
...
export {
    ...
    SmoothlineIcon,
    StackAreaChartIcon,
    StackAreaChartNavyIcon,
    StackBarChartIcon,
    StackBarChartNavyIcon,
    StackHorizontalBarChartIcon,
    StackHorizontalBarChartNavyIcon,
    StatisticCardIcon,
